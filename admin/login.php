...
<body class="bg-gradient-primary">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center rounded bg-light mt-3 mb-5">
            ...
            <div class="col-lg-7">
                <div class="p-5">
                    ...
                    <br><br>
                    <div class="text-center">
                        Don't have an account?<br><a href="register.php">Create one!</a>
                    </div>
                    <br>
                    <?php
                    if (isset($_GET['err'])) {
                        ...
                        elseif($_GET['err'] == 'wrongpwd') {
                            echo '<div style="text-align:center" class="alert alert-danger p-2" role="alert">Incorrect credentials!</div>';
                        }
                        elseif($_GET['err'] == 'none') {
                            echo '<div style="text-align:center" class="alert alert-success p-2" role="alert">You have logged in!</div>';
                        }
                    }
                    ?>
                </div>
